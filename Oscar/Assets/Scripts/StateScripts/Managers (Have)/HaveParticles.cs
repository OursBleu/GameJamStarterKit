...
public class HaveParticles : Manager {
    ...
    public ParticleSystem Play(string path, Vector3 direction, bool looping=false)
    {
        GameObject prefab = Resources.Load(path) as GameObject;
        ParticleSystem ps = Instantiate(prefab, transform.position, MapRotationToDirection(prefab.transform.rotation, direction)) as ParticleSystem;
