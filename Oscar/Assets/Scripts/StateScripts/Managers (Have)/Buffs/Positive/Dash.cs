...
public class Dash : PositiveBuff
{
    private float _parameter;
    public float Parameter { get { return _parameter; } set { _parameter = value; } }

    public Dash(GameObject self, float duration) : base(self, duration)
    {
        _parameter = 300f;
    }

    public Dash(GameObject self, float duration, float parameter) : base(self, duration)
    {
